...
# SENTRY
ROM_PROVIDERS_ENABLED: Final[bool] = safe_str_to_bool(_get_env("ROM_PROVIDERS_ENABLED"))
PROVIDER_QBITTORRENT_URL: Final[str] = _get_env("PROVIDER_QBITTORRENT_URL", "")
PROVIDER_QBITTORRENT_USERNAME: Final[str] = _get_env("PROVIDER_QBITTORRENT_USERNAME", "")
PROVIDER_QBITTORRENT_PASSWORD: Final[str] = _get_env("PROVIDER_QBITTORRENT_PASSWORD", "")
PROVIDER_QBITTORRENT_SAVE_PATH: Final[str] = _get_env("PROVIDER_QBITTORRENT_SAVE_PATH", "/downloads/romm")
PROVIDER_DOWNLOAD_PATH: Final[str] = _get_env("PROVIDER_DOWNLOAD_PATH", f"{ROMM_BASE_PATH}/provider-downloads")
